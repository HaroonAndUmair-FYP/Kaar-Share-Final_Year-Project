...
const Verification: React.FC = ({route}) => {
    ...
    <S.Container>
      <S.InnerContainer>
        ...
        <S.Description>
          ...
          <S.Description bold>{route.params.paramKey} </S.Description>
        </S.Description>
        <S.CodeContainer>
          ...
          <CodeInput
            returnKeyType="send"
            onChangeText={() => navigation.navigate('SignUpRider')}
            onSubmitEditing={() => navigation.navigate('SignUpRider')}
            ref={codeRef4}
          />
        </S.CodeContainer>
      </S.InnerContainer>
